...
public class AchievementTable  
{
   ...
   {
      this.setColumnName("Achievement");
      columnMap.put(this.getColumnName(), 0);
      for (Achievement current : start)
      {
   ...
   public AchievementTable setTable(ArrayList<ArrayList<Object>> value)
   {
      this.table = value;
      return this;
   }
   ...
   public AchievementTable setColumnName(String value)
   {
   ...
   public AchievementTable setColumnMap(LinkedHashMap<String, Integer> value)
   {
   ...
   public StringTable expandGrade(String... rowName)
   {
      ...
      {
         Achievement start = (Achievement) row.get(columnMap.get(this.getColumnName()));
   ...
   public SEClassTable expandSeClass(String... rowName)
   {
      ...
      for (ArrayList<Object> row : oldTable)
      {
         Achievement start = (Achievement) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getSeClass());
         this.table.add(newRow);
      }
      return result;
   }

   public AchievementTable hasSeClass(SEClassTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public SEStudentTable expandStudent(String... rowName)
   {
   ...
   public AchievementTable hasStudent(SEStudentTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public AchievementTable hasSolutions(SolutionTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public AchievementTable selectColumns(String... columnNames)
   {
   ...
   public AchievementTable dropColumns(String... columnNames)
   {
      LinkedHashMap<String, Integer> oldColumnMap = (LinkedHashMap<String, Integer>) this.columnMap.clone();
      this.columnMap.clear();
   ...
   public AchievementTable filter(Predicate< Achievement > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public AchievementTable filterRow(Predicate<LinkedHashMap<String,Object> > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LinkedHashSet< Achievement > toSet()
   {
      LinkedHashSet< Achievement > result = new LinkedHashSet<>();
      for (ArrayList row : this.table)
      {
         Achievement value = (Achievement) row.get(columnMap.get(columnName));
         result.add(value);
      }
      return result;
   }
