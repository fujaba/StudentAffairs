...
public class SEStudentTable  
{

   public SEStudentTable(SEStudent... start)
   {
      this.setColumnName("SEStudent");
      columnMap.put(this.getColumnName(), 0);
      for (SEStudent current : start)
      {
   ...
   public SEStudentTable setTable(ArrayList<ArrayList<Object>> value)
   {
      this.table = value;
      return this;
   }
   ...
   public SEStudentTable setColumnName(String value)
   {
   ...
   public SEStudentTable setColumnMap(LinkedHashMap<String, Integer> value)
   {
   ...
   public SEStudentTable hasGroup(SEGroupTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public AchievementTable expandAchievements(String... rowName)
   {
      ...
      {
         SEStudent start = (SEStudent) row.get(columnMap.get(this.getColumnName()));
         for (Achievement current : start.getAchievements())
         {
            ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
            newRow.add(current);
            this.table.add(newRow);
   ...
   public SEStudentTable hasAchievements(AchievementTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
      {
         ...
         if (start.getAchievements().contains(other))
         {
            this.table.add(row);
         }
      }
   ...
   public SEStudentTable selectColumns(String... columnNames)
   {
   ...
   public SEStudentTable dropColumns(String... columnNames)
   {
      LinkedHashMap<String, Integer> oldColumnMap = (LinkedHashMap<String, Integer>) this.columnMap.clone();
      this.columnMap.clear();
   ...
   public SEStudentTable filter(Predicate< SEStudent > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public SEStudentTable filterRow(Predicate<LinkedHashMap<String,Object> > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LinkedHashSet< SEStudent > toSet()
   {
      LinkedHashSet< SEStudent > result = new LinkedHashSet<>();
      for (ArrayList row : this.table)
      {
         SEStudent value = (SEStudent) row.get(columnMap.get(columnName));
         result.add(value);
      }
      return result;
   }
