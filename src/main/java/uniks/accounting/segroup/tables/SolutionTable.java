...
public class SolutionTable  
{
   ...
   public SolutionTable(Solution... start)
   {
      this.setColumnName("Solution");
      columnMap.put(this.getColumnName(), 0);
      for (Solution current : start)
      {
   ...
   public SolutionTable setTable(ArrayList<ArrayList<Object>> value)
   {
      this.table = value;
      return this;
   }
   ...
   public SolutionTable setColumnName(String value)
   {
   ...
   public SolutionTable setColumnMap(LinkedHashMap<String, Integer> value)
   {
   ...
   public StringTable expandGitUrl(String... rowName)
   {
      ...
      {
         Solution start = (Solution) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getGitUrl());
   ...
   public AchievementTable expandAchievement(String... rowName)
   {
      AchievementTable result = new AchievementTable();
      result.setColumnMap(this.columnMap);
      ...
      for (ArrayList<Object> row : oldTable)
      {
         Solution start = (Solution) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getAchievement());
         this.table.add(newRow);
      }
      return result;
   }

   public SolutionTable hasAchievement(AchievementTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
      {
         Solution start = (Solution) row.get(columnMap.get(this.getColumnName()));
         Achievement other = (Achievement) row.get(columnMap.get(rowName.getColumnName()));
         if (start.getAchievement() == other)
         {
            this.table.add(row);
         }
      }
   ...
   public SolutionTable hasAssignment(AssignmentTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public SolutionTable selectColumns(String... columnNames)
   {
   ...
   public SolutionTable dropColumns(String... columnNames)
   {
      LinkedHashMap<String, Integer> oldColumnMap = (LinkedHashMap<String, Integer>) this.columnMap.clone();
      this.columnMap.clear();
   ...
   public SolutionTable filter(Predicate< Solution > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public SolutionTable filterRow(Predicate<LinkedHashMap<String,Object> > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LinkedHashSet< Solution > toSet()
   {
      LinkedHashSet< Solution > result = new LinkedHashSet<>();
      for (ArrayList row : this.table)
      {
         Solution value = (Solution) row.get(columnMap.get(columnName));
         result.add(value);
      }
      return result;
   }
   ...
   public SolutionFolderTable expandFolder(String... rowName)
   {
   ...
   public SolutionTable hasFolder(SolutionFolderTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
