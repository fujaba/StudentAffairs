...
public class LecturerTable  
{
   ...
   public LecturerTable(Lecturer... start)
   {
      this.setColumnName("Lecturer");
      columnMap.put(this.getColumnName(), 0);
      for (Lecturer current : start)
      {
   ...
   public LecturerTable setTable(ArrayList<ArrayList<Object>> value)
   {
      this.table = value;
      return this;
   }
   ...
   public LecturerTable setColumnName(String value)
   {
   ...
   public LecturerTable setColumnMap(LinkedHashMap<String, Integer> value)
   {
   ...
   public StringTable expandName(String... rowName)
   {
      ...
      {
         Lecturer start = (Lecturer) row.get(columnMap.get(this.getColumnName()));
   ...
   public LecturerTable hasDepartment(StudentOfficeTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public ExaminationTable expandExaminations(String... rowName)
   {
      ...
      {
         Lecturer start = (Lecturer) row.get(columnMap.get(this.getColumnName()));
         for (Examination current : start.getExaminations())
         {
            ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
            newRow.add(current);
            this.table.add(newRow);
   ...
   public LecturerTable hasExaminations(ExaminationTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
      {
         ...
         if (start.getExaminations().contains(other))
         {
            this.table.add(row);
         }
      }
   ...
   public LecturerTable selectColumns(String... columnNames)
   {
   ...
   public LecturerTable dropColumns(String... columnNames)
   {
      LinkedHashMap<String, Integer> oldColumnMap = (LinkedHashMap<String, Integer>) this.columnMap.clone();
      this.columnMap.clear();
   ...
   public LecturerTable filter(Predicate< Lecturer > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LecturerTable filterRow(Predicate<LinkedHashMap<String,Object> > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LinkedHashSet< Lecturer > toSet()
   {
      LinkedHashSet< Lecturer > result = new LinkedHashSet<>();
      for (ArrayList row : this.table)
      {
         Lecturer value = (Lecturer) row.get(columnMap.get(columnName));
         result.add(value);
      }
      return result;
   }
