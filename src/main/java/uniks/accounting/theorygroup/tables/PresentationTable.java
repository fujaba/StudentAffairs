...
public class PresentationTable  
{
   ...
   public PresentationTable(Presentation... start)
   {
      this.setColumnName("Presentation");
      columnMap.put(this.getColumnName(), 0);
      for (Presentation current : start)
      {
   ...
   public PresentationTable setTable(ArrayList<ArrayList<Object>> value)
   {
      this.table = value;
      return this;
   }
   ...
   public PresentationTable setColumnName(String value)
   {
   ...
   public PresentationTable setColumnMap(LinkedHashMap<String, Integer> value)
   {
   ...
   public intTable expandSlides(String... rowName)
   {
   ...
   public StringTable expandOfficeStatus(String... rowName)
   {
      StringTable result = new StringTable();
      result.setColumnMap(this.columnMap);
      result.setTable(this.table);
      ...
      for (ArrayList<Object> row : oldTable)
      {
         Presentation start = (Presentation) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getOfficeStatus());
         this.table.add(newRow);
      }
      return result;
   }

   public TheoryStudentTable expandStudent(String... rowName)
   {
      TheoryStudentTable result = new TheoryStudentTable();
      result.setColumnMap(this.columnMap);
   ...
   public PresentationTable hasStudent(TheoryStudentTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
      {
         Presentation start = (Presentation) row.get(columnMap.get(this.getColumnName()));
         TheoryStudent other = (TheoryStudent) row.get(columnMap.get(rowName.getColumnName()));
   ...
   public SeminarTable expandSeminar(String... rowName)
   {
      SeminarTable result = new SeminarTable();
      result.setColumnMap(this.columnMap);
      result.setTable(table);
      int newColumnNumber = this.table.size() > 0 ? this.table.get(0).size() : 0;
      ...
      for (ArrayList<Object> row : oldTable)
      {
         Presentation start = (Presentation) row.get(columnMap.get(this.getColumnName()));
         ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
         newRow.add(start.getSeminar());
         this.table.add(newRow);
      }
      return result;
   }

   public PresentationTable hasSeminar(SeminarTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
      {
         Presentation start = (Presentation) row.get(columnMap.get(this.getColumnName()));
         Seminar other = (Seminar) row.get(columnMap.get(rowName.getColumnName()));
         if (start.getSeminar() == other)
         {
            this.table.add(row);
         }
      }
   ...
   public PresentationTable selectColumns(String... columnNames)
   {
   ...
   public PresentationTable dropColumns(String... columnNames)
   {
      LinkedHashMap<String, Integer> oldColumnMap = (LinkedHashMap<String, Integer>) this.columnMap.clone();
      this.columnMap.clear();
   ...
   public PresentationTable filter(Predicate< Presentation > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public PresentationTable filterRow(Predicate<LinkedHashMap<String,Object> > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LinkedHashSet< Presentation > toSet()
   {
      LinkedHashSet< Presentation > result = new LinkedHashSet<>();
      for (ArrayList row : this.table)
      {
         Presentation value = (Presentation) row.get(columnMap.get(columnName));
         result.add(value);
      }
      return result;
   }
   ...
   public intTable expandScholarship(String... rowName)
   {
      intTable result = new intTable();
      result.setColumnMap(this.columnMap);
      result.setTable(this.table);
