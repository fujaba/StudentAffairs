...
public class TheoryGroupTable 
{
   ...
   {
      this.setColumnName("TheoryGroup");
      columnMap.put(this.getColumnName(), 0);
      for (TheoryGroup current : start)
      {
   ...
   public TheoryGroupTable setTable(ArrayList<ArrayList<Object>> value)
   {
      this.table = value;
      return this;
   }
   ...
   public TheoryGroupTable setColumnName(String value)
   {
   ...
   public TheoryGroupTable setColumnMap(LinkedHashMap<String, Integer> value)
   {
   ...
   public StringTable expandHead(String... rowName)
   {
      ...
      {
         TheoryGroup start = (TheoryGroup) row.get(columnMap.get(this.getColumnName()));
   ...
   public SeminarTable expandSeminars(String... rowName)
   {
      ...
      {
         TheoryGroup start = (TheoryGroup) row.get(columnMap.get(this.getColumnName()));
         for (Seminar current : start.getSeminars())
         {
            ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
            newRow.add(current);
            this.table.add(newRow);
   ...
   public TheoryGroupTable hasSeminars(SeminarTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
      {
         ...
         if (start.getSeminars().contains(other))
         {
            this.table.add(row);
         }
      }
   ...
   public TheoryStudentTable expandStudents(String... rowName)
   {
      ...
      {
         TheoryGroup start = (TheoryGroup) row.get(columnMap.get(this.getColumnName()));
         for (TheoryStudent current : start.getStudents())
         {
            ArrayList<Object> newRow = (ArrayList<Object>) row.clone();
            newRow.add(current);
            this.table.add(newRow);
   ...
   public TheoryGroupTable hasStudents(TheoryStudentTable rowName)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public TheoryGroupTable selectColumns(String... columnNames)
   {
   ...
   public TheoryGroupTable dropColumns(String... columnNames)
   {
      LinkedHashMap<String, Integer> oldColumnMap = (LinkedHashMap<String, Integer>) this.columnMap.clone();
      this.columnMap.clear();
   ...
   public TheoryGroupTable filter(Predicate< TheoryGroup > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public TheoryGroupTable filterRow(Predicate<LinkedHashMap<String,Object> > predicate)
   {
      ArrayList<ArrayList<Object> > oldTable = (ArrayList<ArrayList<Object> >) this.table.clone();
      this.table.clear();
      for (ArrayList<Object> row : oldTable)
   ...
   public LinkedHashSet< TheoryGroup > toSet()
   {
      LinkedHashSet< TheoryGroup > result = new LinkedHashSet<>();
      for (ArrayList row : this.table)
      {
         TheoryGroup value = (TheoryGroup) row.get(columnMap.get(columnName));
         result.add(value);
      }
      return result;
   }
